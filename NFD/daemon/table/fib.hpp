...
public: // lookup
  ...
  /***DMIF***/ 
const uint32_t 
Fib_findExactMatch_dmif(const Name& prefix, uint32_t forwarderId, bool allowInsert, bool interest_or_data, uint32_t iOrd);
 /***DMIF***/ 
 ...
 /***BF***/ 
void 
Fib_insert_name(const Name& name,  uint32_t x, uint32_t IoD);

void 
Fib_insert_name2(const Name& name,  uint32_t x,  uint32_t y, uint32_t IoD);

uint32_t
Fib_check_name1(const Name& name,  uint32_t x, uint32_t IoD);

uint32_t
Fib_check_name2(const Name& name,  uint32_t x,  uint32_t y, uint32_t IoD);


uint32_t
Fib_check_input1(const Name& name, uint32_t IoD);

uint32_t
Fib_check_input2(const Name& name,  uint32_t x,  uint32_t y, uint32_t IoD);

uint32_t
Fib_check_output2(const Name& name,  uint32_t x,  uint32_t y, uint32_t IoD);


void
Fib_lock (const Name& name, uint32_t x,  uint32_t y, uint32_t IoD);


void 
Fib_clear_name1(const Name& name,  uint32_t x, uint32_t IoD);

void 
Fib_clear_name(const Name& name,  uint32_t x,  uint32_t y, uint32_t IoD);
