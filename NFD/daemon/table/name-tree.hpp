...
public: // matching
 ...
 /*********** DMIF *******/
uint32_t
  NameTree_findExactMatch_dmif(const Name& name, size_t prefixLen, uint32_t forwarderId, bool allowInsert, bool interest_or_data, uint32_t iOrd);
/*********** DMIF *******/
...
void
NameTree_insert_name(const Name& name,  uint32_t x, uint32_t IoD);

void
NameTree_insert_name2(const Name& name,  uint32_t x, uint32_t y, uint32_t IoD);

                                             	     
uint32_t		  
NameTree_check_name1(const Name& name,  uint32_t x, uint32_t IoD);


uint32_t		  
NameTree_check_name2(const Name& name,  uint32_t x,  uint32_t y, uint32_t IoD);
	

 
uint32_t		  
NameTree_check_input1(const Name& name, uint32_t IoD);

 
uint32_t		  
NameTree_check_input2(const Name& name,  uint32_t x,  uint32_t y, uint32_t IoD);


uint32_t		  
NameTree_check_output2(const Name& name,  uint32_t x,  uint32_t y, uint32_t IoD);

void
NameTree_lock (const Name& name, uint32_t x,  uint32_t y, uint32_t IoD);

void
NameTree_clear_name1(const Name& name,  uint32_t x, uint32_t IoD);

void
NameTree_clear_name(const Name& name,  uint32_t x,  uint32_t y, uint32_t IoD);
